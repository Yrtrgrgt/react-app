...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden text-gray-300 bg-[#020617]">
      {/* 🌫️ Top Fade Overlay */}
      <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-b from-[#020617] via-[#020617]/80 to-transparent z-20" />
      ...
      <motion.div
        ...
        animate={{
          background: [
            "linear-gradient(to bottom, #020617 0%, #0f172a 20%, #1e3a8a 60%, #020617 100%)",
            "linear-gradient(to bottom, #020617 0%, #0f172a 20%, #2563eb 60%, #020617 100%)",
          ],
        }}
